...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=Data+Mining+Based+Abnormal+Trading+Pattern+Detection;Isolation+Forest+%2B+%2B+KMeans;Detecting+Abnormal+Market+Signals;Feature+Engineering+for+Financial+Time+Series;Visualizing+Trading+Behavior+Patterns&font=Fira%20Code&center=true&width=750&height=50&duration=3500&pause=1000" alt="Typing SVG">
</p>
...
1. 정답 라벨이 없다.
   탐지된 이상 거래가 실제 불공정거래, 시세조종, 또는 위법 거래를 의미하는 것은 아니다.
